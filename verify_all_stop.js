...
const etfs = [
  ...
  { name: '恒生ETF', secid: '100.HSI', targetOpen: 2.56, targetStop: -1.07, price: 1.485 },
  { name: '中证A100', secid: '1.000903', targetOpen: 1.13, targetStop: -1.37, price: 4361.06 },
  { name: '纳指ETF', secid: '100.NDX', targetOpen: 2.14, targetStop: -1.04, price: 1.716 },
  ...
  { name: '黄金ETF', secid: '118.AU9999', targetOpen: 5.69, targetStop: -1.98, price: 9.45 }
];
...
const run = async () => {
  ...
  for (const etf of etfs) {
    ...
    console.log(`${etf.name}: Target=${etf.targetStop}%, Calc=${stopCalc.toFixed(2)}%`);
  }
};
